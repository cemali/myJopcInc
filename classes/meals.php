...
?>
   ...
   <div class="page content">
     <div id="columnl"> 
              <h1>Meals at Joint Olive Prayer Connections(JOPC)</h1>
<p> A monthly meal Schedule is prepared with you in mind.  We offer healthy and nutritious meals that accommodate special diets along with afternoon snacks. </p>





<!-- calendar_EventTable.php -->
<!-- MLH 10-14-2012 -->
